...
use App\Http\Middleware\TeacherOrStudentMiddleware;
...
class TeacherOrStudentMiddlewareTest extends TestCase
{
    use RefreshDatabase;

    public function test_handle_valid_with_teacher()
    {
        ...
        $middleware = new TeacherOrStudentMiddleware();
    ...
    public function test_handle_valid_with_student()
    {
